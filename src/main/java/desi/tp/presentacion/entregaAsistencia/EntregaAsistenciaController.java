...
public class EntregaAsistenciaController {
 ...
 // *** ENDPOINT PARA EL LISTADO FILTRADO ***
    ...
    public String registrarEntrega(@ModelAttribute("entregaForm") RegistrarEntregaRequestDTO request, Model model, RedirectAttributes redirectAttrs) {
        try {
            entregaAsistenciaService.registrarEntrega(
